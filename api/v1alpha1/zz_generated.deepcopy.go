...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerMaintenanceRefList) DeepCopyInto(out *ServerMaintenanceRefList) {
	*out = *in
	if in.ServerMaintenanceRef != nil {
		in, out := &in.ServerMaintenanceRef, &out.ServerMaintenanceRef
		*out = new(v1.ObjectReference)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerMaintenanceRefList.
func (in *ServerMaintenanceRefList) DeepCopy() *ServerMaintenanceRefList {
	if in == nil {
		return nil
	}
	out := new(ServerMaintenanceRefList)
	in.DeepCopyInto(out)
	return out
}

...
func (in *BIOSVersionSpec) DeepCopyInto(out *BIOSVersionSpec) {
	*out = *in
	in.VersionUpdateSpec.DeepCopyInto(&out.VersionUpdateSpec)
	if in.ServerRef != nil {
		in, out := &in.ServerRef, &out.ServerRef
		*out = new(v1.LocalObjectReference)
		**out = **in
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionUpdateSpec) DeepCopyInto(out *VersionUpdateSpec) {
	*out = *in
	if in.UpdatePolicy != nil {
		in, out := &in.UpdatePolicy, &out.UpdatePolicy
		*out = new(UpdatePolicy)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionUpdateSpec.
func (in *VersionUpdateSpec) DeepCopy() *VersionUpdateSpec {
	if in == nil {
		return nil
	}
	out := new(VersionUpdateSpec)
	in.DeepCopyInto(out)
	return out
}

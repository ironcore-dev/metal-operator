...
type ServerMetadata struct {
	...
	// Enrichment stores additional metadata from external systems (CMDB, Netbox, ServiceNow, etc.).
	// This is a cache populated by external controllers, NOT by hardware discovery.
	// Keys follow a hierarchical naming convention: "system.category/attribute"
	//
	// Examples:
	...
	//   "asset.management/asset-tag": "12345"
	//   "asset.management/purchase-date": "2024-01-15"
	//   "external.system/id": "123"
	//   "external.system/name": "netbox"
	//   "external.system/url": "https://netbox.example.com/dcim/devices/123/"
	//   "external.system/sync-at": "2024-03-28T10:15:30Z"
	//
	// External controllers can use any keys, but standardized keys (see constants.go)
	// are recommended for interoperability with visualizers and other tools.
	// +optional

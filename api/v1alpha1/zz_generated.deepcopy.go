...
func (in *BIOSSettingsStatus) DeepCopyInto(out *BIOSSettingsStatus) {
	*out = *in
	...
	if in.AutoRetryCountRemaining != nil {
		in, out := &in.AutoRetryCountRemaining, &out.AutoRetryCountRemaining
		*out = new(int32)
		**out = **in
	}
	if in.Conditions != nil {
...
func (in *BIOSSettingsTemplate) DeepCopyInto(out *BIOSSettingsTemplate) {
	*out = *in
	...
	if in.FailedAutoRetryCount != nil {
		in, out := &in.FailedAutoRetryCount, &out.FailedAutoRetryCount
		*out = new(int32)
		**out = **in
	}
}

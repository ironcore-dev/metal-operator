...
func (b *BIOSSettingsSpecApplyConfiguration) WithRetryPolicy(value *RetryPolicyApplyConfiguration) *BIOSSettingsSpecApplyConfiguration {
	b.BIOSSettingsTemplateApplyConfiguration.RetryPolicy = value
	return b
}

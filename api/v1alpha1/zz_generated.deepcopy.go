...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BMCSettingsMap) DeepCopyInto(out *BMCSettingsMap) {
	*out = *in
	if in.Settings != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BMCSettingsMap.
func (in *BMCSettingsMap) DeepCopy() *BMCSettingsMap {
	if in == nil {
		return nil
	}
	out := new(BMCSettingsMap)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BMCSettingsSpec) DeepCopyInto(out *BMCSettingsSpec) {
	*out = *in
	in.BMCSettings.DeepCopyInto(&out.BMCSettings)
	if in.ServerRefList != nil {
		in, out := &in.ServerRefList, &out.ServerRefList
	...
	if in.ServerMaintenanceRefMap != nil {
		in, out := &in.ServerMaintenanceRefMap, &out.ServerMaintenanceRefMap
